...
function totalDigitRekursif(angka) {
  ...
  return (angka % 10) + totalDigitRekursif(Math.floor(angka / 10)); // kenapa di modulo 10 dan dibagi 10? karena dengan modulo 10, karena kalo di modulo 10 i bisa didapat digit terakhirnya, kalo dibagi 10 i bisa dihapus digit terkahirnya mek.
}
// console.log(Math.floor(512/10))
// TEST CASES
